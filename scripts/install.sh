...
printf "\n"
printf "  Next steps:\n"
printf "    1. Edit .env and fill in your AI endpoint/model settings.\n"
printf "    2. Check setup: ./scripts/check_setup.sh\n"
printf "    3. Open GUI:    ./scripts/run_gui.sh\n"
printf "\n"
printf "  CLI examples:\n"
printf "    %s autocut.py autocut <video.lrv-or-mp4> --prompt \"...\" -o output.mp4\n" "$VENV_PYTHON"
printf "    ./scripts/run_script_mode.sh <video1> [video2 ...] --auto-prompt -o output.mp4\n"
printf "\n"
